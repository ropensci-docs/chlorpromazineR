...
This is the first CRAN release of the package. The package has just
passed peer-review through rOpenSci. It is published in a fully
functional state.
...
Added additional tests to compare results to spreadsheet by Leucht et
al. with similar purpose.
